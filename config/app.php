...
return [
    ...
    */
    ...
    'url' => env('APP_URL', (
        php_sapi_name()==='cli' OR defined('STDIN')) ?
        'http://localhost' :
    ...
    */
    ...
    'providers' => [
         ...
         */
        App\Larapen\Providers\AppServiceProvider::class,
        App\Larapen\Providers\AuthServiceProvider::class,
        App\Larapen\Providers\EventServiceProvider::class,
        App\Larapen\Providers\RouteServiceProvider::class,
        App\Larapen\Providers\ValidatorServiceProvider::class,
        ...
        Larapen\Base\BaseServiceProvider::class,
		...
		Larapen\LangFileManager\LangFileManagerServiceProvider::class,
		Larapen\Settings\SettingsServiceProvider::class,
        Larapen\CRUD\CrudServiceProvider::class,
        'Larapen\Elfinder\ElfinderServiceProvider',
    ...
    */
    ...
    'aliases' => [
        ...
        'CRUD' => 'Larapen\CRUD\CrudServiceProvider',
