...
trait CrudTrait
{
	...
	*/
	...
	{
		$instance = new static(); // create an instance of the model to be able to get the table name
		$answer = DB::select(DB::raw("SELECT IS_NULLABLE FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME='".DB::getTablePrefix().$instance->getTable()."' AND COLUMN_NAME='".$column_name."' AND table_schema='".env('DB_DATABASE')."'"))[0];
    ...
    */
	...
	{
		return $this->belongsTo('\App\Larapen\Models\Language', 'translation_lang', 'abbr');
	}
