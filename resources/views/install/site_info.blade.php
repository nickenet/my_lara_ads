...
@section('content')
	...
	<form action="{{ $installUrl . '/site_info' }}" method="POST" class="form-validate-jqueryz">
		{!! csrf_field() !!}
		...
		<div class="text-right">
			<button data-wait="{{ trans('messages.button_processing') }}" type="submit" class="btn btn-primary">
